...
std::string Pages::get_default_error_page(event_http_status_enum_t status) {
    ...
    switch (status) {
        case BAD_REQUEST: return error400;
        case FORBIDDEN: return error403;
        case NOT_FOUND: return error404;
        case METHOD_NOT_ALLOWED: return error405;
        case PAYLOAD_TOO_LARGE: return error413;
        case INTERNAL_SERVER_ERROR: return error500;
